            ...
            <a href="/dashboard">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        {{-- <form method="get" class="d-flex search" role="search" style="width: 380px;">
                        ...
                        <form method="get" class="d-flex search" role="search" style="width: 380px;">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-sm border-start border-dark-subtle buttonsearch"
                                        style="width: 45px;">
                                        <img src="{{ asset('build/assets/icon/search.png') }}" alt="Search Icon" style="width: 28px">
                                    </button>
                                </div>
                            </div>
                        </form>
