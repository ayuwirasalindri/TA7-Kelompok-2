...
<body>
    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-7">
            <div class="card">
                <div class="card-body">
                    <h3 class="login-text text-center">Sign Up</h3>
                    <p class="login-text2 text-center" text-center style="color: #A4A4A4;">Already have an account? <a
                            href="login.html" class="login-text2" style="color: #A21608;">Login</a></p>
                    <button type="button" class="btn btn-secondary btn-lg btn-block login-text2"
                        style="background-color: white; color: #645F5F;">
                        <img src="google.png" alt="" class="img-fluid px-1" width="20px" height="20px" />
                        Google</button>
                    ...
                    <form>
                        ...
                        <div class="col-sm-12">
                            <label for="Password" class="form-label login-text2"
                                style="color: #645F5F;">Repassword</label>
                            <input type="password" class="form-control" id="Repassword" />
                        </div>
                        <div class="mb-3 mt-3">
                            <a href="/telufinds" type="submit" class="btn btn-primary login-text2">Sign Up</a>
                        </div>
                    </form>
